...
namespace BarcodeLib.Symbologies
{
    ...
    class JAN13 : BarcodeCommon, IBarcode
    {
        ...
        {
            if (!Raw_Data.StartsWith("49")) Error("EJAN13-1: 无效的国家代码 在JAN13中 (49 required)");//Error("EJAN13-1: Invalid Country Code for JAN13 (49 required)");
            if (!BarcodeLib.Barcode.CheckNumericOnly(Raw_Data))
                Error("EJAN13-2: 只能是数字"); //Error("EJAN13-2: Numeric Data Only");
