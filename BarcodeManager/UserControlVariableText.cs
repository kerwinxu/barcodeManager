...
{
    public partial class UserControlVariableText : UserControl
    {
        public int intID;//就是ID而已

        public UserControlVariableText()
        {
            InitializeComponent();
        ...
        //变量值
        public string strVariableValue
        {
            get
            {
                return txtVaribaleValue.Text;
            }
            set
            {
                txtVaribaleValue.Text = value;
            }
        }
        //后缀
        ...
        private void comboBoxVaribaleName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (clsKeyValue keyvalue in frmMain.arrlistSellectRow)
            {
                ...
                {
                    txtVaribaleValue.Text = keyvalue.Value;
                    return;
                }
            }
        }
