...
namespace Xuhengxiao.MyDataStructure
{
        ...
        public class ClsGuessEncoding
        {
			...
			{
				"GB2312", "GBK", "hz-gb-2312", "Big5", "CNS 11643", 
				"ISO 2022CN", "UTF-8", "Unicode", "us-ascii", "OTHER"
			};
            ...
            /// </summary>
            public ClsGuessEncoding() { Initialize_Frequencies(); }
            #endregion

            #region Instance
            private static ClsGuessEncoding _instance;
            private static object _lockObj = new object();
            public static ClsGuessEncoding Instance
            {
                get
                {
                    if (_instance == null)
                    {
                        lock (_lockObj)
                        {
                            if (_instance == null)
                            {
                                _instance = new ClsGuessEncoding();
                            }
                        }
                    }
            ...
            /// <returns>返回编码类型（"GB2312", "GBK", "hz-gb-2312", "Big5", "CNS 11643", "ISO 2022CN", "UTF-8", "Unicode", "us-ascii", "OTHER"）</returns>
            /// <example>
